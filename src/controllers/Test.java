...
public class Test extends UserAwareController {
  ...
  public Result get() {
    ...
    hibernate.flush();
    hibernate.save(new Metric(goal1, "Some metric", "", "", "", 0, "", 33, "", "", "aa", 1.0, true));
    hibernate.flush();
    hibernate.save(new Metric(goal1, "Some other metric", "", "", "abc", 777, "", 0, "", "", "", 2.0, true));
    hibernate.flush();

    Goal goal2 = new Goal("Second goal","", 100, 1);
    hibernate.save(goal2);
    hibernate.flush();
    hibernate.save(new Metric(goal2, "A metric", "", "", "", 8, "", 33, "", "cnf tgh", "aa", 1.0, true));
    hibernate.flush();

    Metric metric = new Metric(goal2, "ABC metric", "", "", "abc", 0, "", 0, "", "dfghdtgfy iutyuio", "", 2.0, true);
    ...
    metric = new Metric(goal2, "DEF metric", "", "", "def", 0, "", 0, "", "dsfhgf iutyuio", "dsfhgjk", 3.0, true);
    metric.setValues(new HashMap<Integer, BigDecimal>() {{

...
public class EnforceAuthentication extends UITest {
  ...
  public void logIn() throws Exception {
    ...
    hibernate.save(goal);
    hibernate.save(new Metric(goal, "Some metric", "", "", "", 0, "", 0, "", "tt", "", 2.2, true));
    hibernate.save(new Metric(goal, "Other metric", "", "", "", 2, "", 0, "", "", "dd", 2.3, true));
    hibernate.save(new Metric(goal, "Third metric", "", "", "jj", 8, "", 0, "", "", "dd", 2.4, true));
  }

...
public class AbstractMetricChartTest extends ControllerTest<AbstractMetricChartTest.TestAbstractMetricChart>{
  ...
  public void prepareJson() throws Exception {
    ...
    assertEquals("[[[\"%\",\"mõõdik\",\"null\"], [\"2014 (- / 25)\",25,\"2014 Prognoos: - Tulemus: 25 %\"], [\"2015 (- / 30)\",30,\"2015 Prognoos: - Tulemus: 30 %\"], [\"2016 (- / 35)\",35,\"2016 Prognoos: - Tulemus: 35 %\"], [\"2017 (- / -)\",0,\"2017 Prognoos: - Tulemus: -\"], [\"2018 (- / -)\",0,\"2018 Prognoos: - Tulemus: -\"], [\"2019 (- / -)\",0,\"2019 Prognoos: - Tulemus: -\"], [\"2020 (- / -)\",0,\"2020 Prognoos: - Tulemus: -\"]], [[\"%\",\"mõõdik\",\"null\"], [\"2014\",0, \"\"], [\"2015\",0, \"\"], [\"2016\",0, \"\"], [\"2017\",0, \"\"], [\"2018\",0, \"\"], [\"2019\",0, \"\"], [\"2020\",0, \"\"]]]",controller.jsonResponse);
  }
